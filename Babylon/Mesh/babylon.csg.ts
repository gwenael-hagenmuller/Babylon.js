module BABYLON {
    ...
    export class CSG {
        ...
        public static FromVertexData(vertexData: VertexData): CSG {
            var polygons = [];
            var polygon;
            ...
            //VertexData is like a mesh at the origin of the world so vectors do not need to be transformed
        ...
        public buildVertexDataGeometry(): VertexData {
            var matrix = this.matrix.clone();
            matrix.invert();
        ...
        public toVertexData(): VertexData {
